...
class ValOptions():
    def initialize(self):
        ...
        parser.add_argument("--val-data-list", type=str, default=DATA_LIST_VAL_PATH)
        parser.add_argument("--test-data-list", type=str, default=DATA_LIST_TEST_PATH)
        parser.add_argument('--num_classes', type=int, default=NUM_CLASSES)
        parser.add_argument("--restore-from", type=str, default='')
        parser.add_argument("--gpu", type=str, default='None')
        parser.add_argument("--figsavepath", type=str, default='outputs', help="")
        parser.add_argument("--type", type=str, default='val', help="")
        args = parser.parse_args()
